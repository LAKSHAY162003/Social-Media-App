...
// Imported so as to : make the : like button red !!
    ...
    return (
        <Card sx={{ maxWidth: 800, margin: "auto", paddingBottom: "5rem" }}>
            <CardHeader
                ...
                subheader={picUser.occupation}
            />
            <CardMedia
                component="img"
                height="294"
                width="60%"
                image={`http://localhost:3001/assets/${props.element.picturePath}`}
                alt="Not Found :("
            />
            <CardContent>
